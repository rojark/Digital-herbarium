...
<div id="wrapper">
	...
	<div id="page">
		<div id="page-bgtop">
			<div id="page-bgbtm">
			  <!-- end #content -->
				<!-- end #sidebar -->
			  <div style="color:#00F;font:'Lucida Sans Unicode', 'Lucida Grande', sans-serif;font-size:36px;" align="center">View Plant Details (By Family)</div>
			  <p> &nbsp; </p>
    ...
    ?>
        ...
        <tr>
            ...
            <td> <?php echo "<a href=viewplant_more.php?id=".$row['id'] .">View </a>";?> </td>
        </tr>
  <?php
    }
    }
